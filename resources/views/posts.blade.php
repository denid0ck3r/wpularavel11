        ...
        <form>
            ...
            <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                <div class="relative w-full">
                    ...
                    <input class="block p-3 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:rounded-none sm:rounded-l-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search your article" type="search" id="search" name="search" autocomplete="off">
                </div>
                <div>
...
{{$posts->links()}}
            ...
            <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-3">
                        ...
                        <a href="/blog?authors={{$post->author->username}}" class="text-base text-gray-500 hover:underline">
    ...
    @empty
        <div class="text-center">
            <p class="font-semibold text-xl my-4">Article Not Found
                <a href="/blog" class="block text-blue-600 hover:underline">&laquo; Back to all posts</a></p>
        </div>
@endforelse
</div>  
</div>
